...
test('wide desktop menu panels clear the shop button', async ({ page }, testInfo) => {
  test.skip(testInfo.project.name !== 'chromium-desktop', 'wide viewport regression only applies to desktop layout');
